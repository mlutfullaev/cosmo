...
<template>
  ...
  <section id="reviews" class="reviews" v-if="!store.state.beauty">
    <div class="reviews__text">
      ...
      <router-link to="#" class="link bg-orange">CHECK YOUR SKIN TYPE REVIEWS <span>→</span></router-link>
    </div>
...
<!--  </section>-->
  ...
  <section id="prices" class="prices">
    ...
    <div class="prices__inner">
      ...
      <button @click="pricesMore = true" class="link bg-orange">CHECK YOUR SKIN TYPE REVIEWS <span>→</span></button>
    </div>
